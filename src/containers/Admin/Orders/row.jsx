...
import { ProductImage, StatusSelect } from './style.js';
    ...
    return (
        <>
            <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
                ...
                <TableCell>
                    <StatusSelect options={orderStatusOptions.filter(status => status.id !== 0)} placeholder='Status'
